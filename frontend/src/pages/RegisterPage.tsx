...
export default function RegisterPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (response.data && response.data.token) {
                ...
                setError("Registration succeeded, but no token was returned. Please try logging in.");
            }
        } catch (err: any) {
            if (err.response) {
    ...
    // FIX: Was hardcoded to 'http://localhost:8000/api/v1/auth/google'.
    // In production this would redirect users to their own machine and OAuth would silently fail.
    // LoginPage.tsx had this right already — now RegisterPage matches it.
