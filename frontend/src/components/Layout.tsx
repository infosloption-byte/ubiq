    ...
    <div className="flex h-screen w-full bg-ubiq-950 overflow-hidden text-slate-300 font-sans selection:bg-ubiq-accent/30">
      ...
      <main className="flex-1 flex flex-col h-full relative overflow-hidden bg-ubiq-950 pt-14 md:pt-0">
        {user?.subscription_status === 'past_due' && (
          <div className="flex items-center justify-between gap-3 px-4 py-2.5 bg-amber-500/10 border-b border-amber-500/20 text-amber-300 text-xs font-medium shrink-0">
            ...
            <a href="/settings?tab=billing" className="whitespace-nowrap underline hover:text-amber-200 transition-colors">
              Fix now →
            </a>
          </div>
        )}
